...
###########################################
#### регрессии по компонентам Хофстеде ####
###########################################

data <- read_excel("/Users/artart/Desktop/Диплом/R/Данные/Diploma.xlsx")
data1 <- na.omit(data)
View(data1)
data1$Pop_15_64_2009_mln <- data1$Population_15_64_2009/1000000

#Дистанция власти
data1 <- data.frame(data1)
mod1 <- lm(data = data1, GDP_growth ~ Power.distance + log(Pop_15_64_2009_mln) + Inflation)
summary(mod1)
V_Pd <- vcovHC(mod1, type = "HC0")
V_diag_Pd <- sqrt(diag(V_Pd))

#Индивидуализм
mod2 <- lm(data = data1, GDP_growth ~ Individualism + log(Pop_15_64_2009_mln) + Inflation)
summary(mod2)
...
mod3 <- lm(data = data1, GDP_growth ~ Uncertainty.avoidance + log(Pop_15_64_2009_mln) + Inflation)
summary(mod3)
...
mod4 <- lm(data = data1, GDP_growth ~ Long.term.orientation + log(Pop_15_64_2009_mln) + Inflation)
summary(mod4)
...
#Маскулинность
mod5 <- lm(data = data1, GDP_growth ~ Masculinity + log(Pop_15_64_2009_mln) + Inflation)
summary(mod5)
V_Ma <- vcovHC(mod5, type = "HC0")
V_diag_Ma <- sqrt(diag(V_Ma))

#Удовлетворённость жизнью
mod6 <- lm(data = data1, GDP_growth ~ Indulgence + I(Indulgence^2) + log(Pop_15_64_2009_mln) + Inflation)
summary(mod6)
...
Hofstede <- dplyr::select(data1, Power.distance, Individualism, Masculinity, Uncertainty.avoidance, Long.term.orientation, Indulgence)
corrplot(cor(Hofstede), addCoef.col = TRUE)

#Дистанция власти и индивидуализм
mod7 <- lm(data = data1, GDP_growth ~ Power.distance +Individualism + log(Pop_15_64_2009_mln) + Inflation)
summary(mod7)

#Долгосрочная ориентация и удовлетворённость жизнью
mod13 <- lm(data = data1, GDP_growth ~ Long.term.orientation+Indulgence + log(Pop_15_64_2009_mln) + Inflation)
summary(mod13)


##############################################
#### регрессии по компонентам Шварца 2009 ####
##############################################
...
stargazer(mod1sch,mod2sch,mod3sch, type="html",out = "Schwarz_components_2009.htm")

##############################################
#### регрессии по компонентам Шварца 2010 ####
##############################################
...
stargazer(mod1sch,mod2sch,mod3sch, type="html",out = "Schwarz_components_2010.htm")

##############################################
#### регрессии по компонентам Шварца 2011 ####
##############################################
...
stargazer(mod1sch,mod2sch,mod3sch, type="html",out = "Schwarz_components_2011.htm")
...
summary <- summary(data3)
summary

#строим модель
data3 <- data.frame(data3)
mod <- lm(data = data3, GDPpercap_growth ~ .-Population_2008 - Population_2009 - GDP - Investment - Inv_share - Pop_growth)
summary(mod)
vif(mod)
...
#может добавить степени регрессоров? 
plot(mod, which = 1) 
crPlots(mod)
mod1 <- update(mod, .~. + I(Individualism^2) + I(Uncertainty.avoidance^2) + I(Pop_growth^2) 
               + I(Human_cap_index_2010^2) + I(Long.term.orientation^2) + I(Power.distance^2)+
                 I(Inv_share^2))
crPlots(mod1)
#Оставляем mod1
...
#На данном этапе оставляем mod1

#посмотрим на influencePlot(mod1)
influencePlot(mod1)
#точно удаляем 47,51
data4 <- data3[-c(32,35,40),]
mod2 <- update(mod1, . ~ ., data = data4)
summary(mod2)
influencePlot(mod2)
...
bptest(mod2) #нет гетероскедастичности как зависимости сигмы от регрессора
white_lm(mod2) #нет гетероскедастичности

#по двум тестам гетероскедастичность отсутствует

#вернемся к нормальности:
plot(mod2, which = 2)
#стало лучше

summary(mod2)

#уберём с помощью критерия Акаике
mod3 <- stepAIC(mod2)
mod4 <- update(mod3, . ~. -Power.distance-I(Power.distance^2) - I(Inv_share^2))
summary(mod3)
summary(mod4)
anova(mod3,mod4)
plot(mod4, which = 2)
...
data <- read_excel("/Users/artart/Desktop/Диплом/R/Данные/Hofstede/Hofstede_2009_new.xlsx")
View(data)
data1 <- na.omit(data)
View(data1)
data2 <- data1[,-c(1,2)]
...
#строим модель
data3 <- data.frame(data3)
mod <- lm(data = data3, GDPpercap_growth ~ Power.distance + Individualism + Masculinity + Uncertainty.avoidance + Long.term.orientation+
            Indulgence + Investment + Pop_growth_perc)
summary(mod)
vif(mod)
...
plot(mod, which = 1) 
crPlots(mod)
mod1 <- update(mod, .~. + log(Investment) - Investment + I(Individualism^2) + I(Pop_growth_perc^2))
crPlots(mod1)
#Оставляем mod1
...
#строим модель
data3 <- data.frame(data3)
mod <- lm(data = data3, GDP_growth ~ Power.distance + Individualism + Masculinity + Uncertainty.avoidance + Long.term.orientation+
            Indulgence + Pop_growth_perc + Capital_stock_2009 + Population_15_64_2009_mln)
summary(mod)
vif(mod)
...
plot(mod, which = 1) 
crPlots(mod)
mod1 <- update(mod, .~. + log(Capital_stock_2009) - Capital_stock_2009 + I(Indulgence^2) + I(Pop_growth_perc^2)+
                 I(Power.distance^2) + I(Uncertainty.avoidance^2))
crPlots(mod1)
#Оставляем mod1
...
View(data2)
data3 <- data2[-c(9,20),]
data3$Pop_15_64_2009_mln <- data3$Population_15_64_2009/1000000
View(data3)
...
data3 <- data.frame(data3)
mod <- lm(data = data3, GDP_growth ~ Power.distance + Individualism + Masculinity + Uncertainty.avoidance + Long.term.orientation+
            Indulgence + Capital_stock_2009 + Pop_15_64_2009_mln + Inflation)
summary(mod)
vif(mod)
...
plot(mod, which = 1) 
crPlots(mod)
mod1 <- update(mod, .~. + I(Indulgence^2) + log(Capital_stock_2009) - Capital_stock_2009 + log(Pop_15_64_2009_mln) - Pop_15_64_2009_mln)
crPlots(mod1)
#Оставляем mod1
...
#гетероскедастичность
bptest(mod1) #нет гетероскедастичности как зависимости сигмы от регрессора
white_lm(mod1) #нет гетероскедастичности
...
#строим модель
data3 <- data.frame(data3)
mod_sch <- lm(data = data3, GDP_growth ~ Harmony + Embeddedness + Hierarchy + Mastery + Aff_auton + Intel_auton + Egalitar + Capital_stock_2009 + Pop_15_64_2009_mln + Inflation)
summary(mod_sch)
vif(mod_sch)
mod_sch1 <- update(mod_sch,.~. - Embeddedness)
vif(mod_sch1)
summary(mod_sch1)

#нормальность остатков
plot(mod_sch1, which = 2)


#может добавить степени регрессоров? 
plot(mod_sch1, which = 1) 
crPlots(mod_sch1)
mod_sch2 <- update(mod_sch1, .~. + I(Harmony^2) +I(Egalitar^2)+I(Hierarchy^2)+I(Intel_auton^2)+I(Mastery^2)+I(Aff_auton^2) + log(Capital_stock_2009) - Capital_stock_2009 + log(Pop_15_64_2009_mln) - Pop_15_64_2009_mln)
crPlots(mod_sch2)
...
#гетероскедастичность
bptest(mod_sch2) #нет гетероскедастичности как зависимости сигмы от регрессора
white_lm(mod_sch2) #нет гетероскедастичности

#по двум тестам гетероскедастичность отсутствует

#вернемся к нормальности:
plot(mod_sch2, which = 2)
#стало лучше

summary(mod_sch2)

#уберём с помощью критерия Акаике
mod_sch3 <- stepAIC(mod_sch2)
mod_sch4 <- update(mod_sch3,.~. -I(Intel_auton^2) - Intel_auton)
plot(mod_sch4, which = 2)


#выгружаем модель
library(stargazer)
stargazer(mod_sch4, type = "text")
...
#Регрессии второго шага
#Business_freedom
mod_step211 <- lm(data = data, Electricity ~ Business_freedom + Inflation_2009 + Population_15_64_2009_growth+Capital_stock_2009_growth)
summary(mod_step211)
vif(mod_step211)
...
#Trade_freedom
mod_step221 <- lm(data = data, Electricity ~ Trade_freedom + Inflation_2009 + Population_15_64_2009_growth+Capital_stock_2009_growth)
summary(mod_step221)
vif(mod_step221)
...
#Fiscal_freedom
mod_step231 <- lm(data = data, Electricity ~ Fiscal_freedom + Inflation_2009 + Population_15_64_2009_growth+Capital_stock_2009_growth)
summary(mod_step231)
vif(mod_step231)
...
#Government_size
mod_step241 <- lm(data = data, Electricity ~ Government_size + Inflation_2009 + Population_15_64_2009_growth+Capital_stock_2009_growth)
summary(mod_step241)
vif(mod_step241)
...
#Monetary_freedom
mod_step251 <- lm(data = data, Electricity ~ Monetary_freedom + Inflation_2009 + Population_15_64_2009_growth+Capital_stock_2009_growth)
summary(mod_step251)
vif(mod_step251)
...
#Investment_freedom
mod_step261 <- lm(data = data, Electricity ~ Investment_freedom + Inflation_2009 + Population_15_64_2009_growth+Capital_stock_2009_growth)
summary(mod_step261)
vif(mod_step261)
...
#Financial_freedom
mod_step27 <- lm(data = data, Electricity ~ Financial_freedom + Inflation_2009 + Population_15_64_2009_growth+Capital_stock_2009_growth)
summary(mod_step27)
vif(mod_step27)
...
#Property_rights
mod_step28 <- lm(data = data, Electricity ~ Property_rights + Inflation_2009 + Population_15_64_2009_growth+Capital_stock_2009_growth)
summary(mod_step28)
vif(mod_step28)
...
#Freedom_for_corruption
mod_step29 <- lm(data = data, Electricity ~ Freedom_for_corruption + Inflation_2009 + Population_15_64_2009_growth+Capital_stock_2009_growth)
summary(mod_step29)
vif(mod_step29)
...
#Labour_freedom
mod_step30 <- lm(data = data, Electricity ~ Labour_freedom + Inflation_2009 + Population_15_64_2009_growth+Capital_stock_2009_growth)
summary(mod_step30)
vif(mod_step30)
...
################################################
#### регрессии по компонентам Хофстеде 2009 ####
################################################

data <- read_excel("/Users/artart/Desktop/Диплом/R/Данные/Diploma.xlsx")
data <- dplyr::select(data, LOCATION, Country, GDP_growth_2009, GDP_growth_2010, GDP_growth_2011, Power.distance, Individualism, Masculinity, Uncertainty.avoidance, Long.term.orientation, Indulgence, Inflation_2009, Inflation_2010, Inflation_2011,Population_15_64_2009_growth, Population_15_64_2010_growth,Population_15_64_2011_growth,Capital_stock_2009_growth, Capital_stock_2010_growth, Capital_stock_2011_growth)
data1 <- na.omit(data)
View(data1)
...
#Дистанция власти
data1 <- data.frame(data1)
mod1 <- lm(data = data1, GDP_growth_2009 ~ Power.distance + Population_15_64_2009_growth + Inflation_2009+Capital_stock_2009_growth )
summary(mod1)
V_Pd <- vcovHC(mod1, type = "HC0")
V_diag_Pd <- sqrt(diag(V_Pd))

#Индивидуализм
mod2 <- lm(data = data1, GDP_growth_2009 ~ Individualism + Population_15_64_2009_growth + Inflation_2009+Capital_stock_2009_growth)
summary(mod2)
V_Ind <- vcovHC(mod2, type = "HC0")
V_diag_Ind <- sqrt(diag(V_Ind))
...
#Избегание неопределённости
mod3 <- lm(data = data1, GDP_growth_2009 ~ Uncertainty.avoidance + Population_15_64_2009_growth + Inflation_2009+Capital_stock_2009_growth)
summary(mod3)
V_Ua <- vcovHC(mod3, type = "HC0")
V_diag_Ua <- sqrt(diag(V_Ua))
...
#Долгосрочная ориентация
mod4 <- lm(data = data1, GDP_growth_2009 ~ Long.term.orientation + Population_15_64_2009_growth + Inflation_2009+Capital_stock_2009_growth)
summary(mod4)
V_Lo <- vcovHC(mod4, type = "HC0")
V_diag_Lo <- sqrt(diag(V_Lo))
...
#Маскулинность
mod5 <- lm(data = data1, GDP_growth_2009 ~ Masculinity + Population_15_64_2009_growth + Inflation_2009+Capital_stock_2009_growth)
summary(mod5)
V_Ma <- vcovHC(mod5, type = "HC0")
V_diag_Ma <- sqrt(diag(V_Ma))

#Удовлетворённость жизнью
mod6 <- lm(data = data1, GDP_growth_2009 ~ Indulgence + Population_15_64_2009_growth + Inflation_2009+Capital_stock_2009_growth)
summary(mod6)
V_Ig <- vcovHC(mod6, type = "HC0")
V_diag_Ig <- sqrt(diag(V_Ig))
...
#Дистанция власти и индивидуализм
mod7 <- lm(data = data1, GDP_growth_2009 ~ Power.distance +Individualism + Population_15_64_2009_growth + Inflation_2009+Capital_stock_2009_growth)
summary(mod7)
V_Ind_Pd <- vcovHC(mod7, type = "HC0")
V_diag_Ind_Pd <- sqrt(diag(V_Ind_Pd))

#Долгосрочная ориентация и удовлетворённость жизнью
mod8 <- lm(data = data1, GDP_growth_2009 ~ Long.term.orientation+Indulgence + Population_15_64_2009_growth + Inflation_2009+Capital_stock_2009_growth)
summary(mod8)
V_LR_Ind <- vcovHC(mod8, type = "HC0")
V_diag_LR_Ind <- sqrt(diag(V_LR_Ind))

stargazer(mod1,mod2,mod3,mod4,mod5,mod6,mod7,mod8, type="html",out = "Hofstede_components_2009.htm",se=list(V_diag_Pd, V_diag_Ind,V_diag_Ua,V_diag_Lo,V_diag_Ma,V_diag_Ig,V_diag_Ind_Pd,V_diag_LR_Ind))

################################################
#### регрессии по компонентам Хофстеде 2010 ####
################################################

#Дистанция власти
data1 <- data.frame(data1)
mod1 <- lm(data = data1, GDP_growth_2010 ~ Power.distance + Population_15_64_2010_growth + Inflation_2010+Capital_stock_2010_growth)
summary(mod1)
V_Pd <- vcovHC(mod1, type = "HC0")
V_diag_Pd <- sqrt(diag(V_Pd))

#Индивидуализм
mod2 <- lm(data = data1, GDP_growth_2010 ~ Individualism + Population_15_64_2010_growth + Inflation_2010+Capital_stock_2010_growth)
summary(mod2)
V_Ind <- vcovHC(mod2, type = "HC0")
V_diag_Ind <- sqrt(diag(V_Ind))
...
#Избегание неопределённости
mod3 <- lm(data = data1, GDP_growth_2010 ~ Uncertainty.avoidance + Population_15_64_2010_growth + Inflation_2010+Capital_stock_2010_growth)
summary(mod3)
V_Ua <- vcovHC(mod3, type = "HC0")
V_diag_Ua <- sqrt(diag(V_Ua))
...
#Долгосрочная ориентация
mod4 <- lm(data = data1, GDP_growth_2010 ~ Long.term.orientation + Population_15_64_2010_growth + Inflation_2010+Capital_stock_2010_growth)
summary(mod4)
V_Lo <- vcovHC(mod4, type = "HC0")
V_diag_Lo <- sqrt(diag(V_Lo))
...
#Маскулинность
mod5 <- lm(data = data1, GDP_growth_2010 ~ Masculinity + Population_15_64_2010_growth + Inflation_2010+Capital_stock_2010_growth)
summary(mod5)
V_Ma <- vcovHC(mod5, type = "HC0")
V_diag_Ma <- sqrt(diag(V_Ma))

#Удовлетворённость жизнью
mod6 <- lm(data = data1, GDP_growth_2010 ~ Indulgence + Population_15_64_2010_growth + Inflation_2010+Capital_stock_2010_growth)
summary(mod6)
V_Ig <- vcovHC(mod6, type = "HC0")
V_diag_Ig <- sqrt(diag(V_Ig))
...
#Дистанция власти и индивидуализм
mod7 <- lm(data = data1, GDP_growth_2010 ~ Power.distance +Individualism + Population_15_64_2010_growth + Inflation_2010+Capital_stock_2010_growth)
summary(mod7)
V_Ind_Pd <- vcovHC(mod7, type = "HC0")
V_diag_Ind_Pd <- sqrt(diag(V_Ind_Pd))

#Долгосрочная ориентация и удовлетворённость жизнью
mod8 <- lm(data = data1, GDP_growth_2010 ~ Long.term.orientation+Indulgence + Population_15_64_2010_growth + Inflation_2010+Capital_stock_2010_growth)
summary(mod8)
V_LR_Ind <- vcovHC(mod8, type = "HC0")
V_diag_LR_Ind <- sqrt(diag(V_LR_Ind))

stargazer(mod1,mod2,mod3,mod4,mod5,mod6,mod7,mod8, type="html",out = "Hofstede_components_2010.htm",se=list(V_diag_Pd, V_diag_Ind,V_diag_Ua,V_diag_Lo,V_diag_Ma,V_diag_Ig,V_diag_Ind_Pd,V_diag_LR_Ind))


################################################
#### регрессии по компонентам Хофстеде 2011 ####
################################################

#Дистанция власти
data1 <- data.frame(data1)
mod1 <- lm(data = data1, GDP_growth_2011 ~ Power.distance + Population_15_64_2011_growth + Inflation_2011+Capital_stock_2011_growth)
summary(mod1)
V_Pd <- vcovHC(mod1, type = "HC0")
V_diag_Pd <- sqrt(diag(V_Pd))

#Индивидуализм
mod2 <- lm(data = data1, GDP_growth_2011 ~ Individualism + Population_15_64_2011_growth + Inflation_2011+Capital_stock_2011_growth)
summary(mod2)
V_Ind <- vcovHC(mod2, type = "HC0")
V_diag_Ind <- sqrt(diag(V_Ind))
...
#Избегание неопределённости
mod3 <- lm(data = data1, GDP_growth_2011 ~ Uncertainty.avoidance + Population_15_64_2011_growth + Inflation_2011+Capital_stock_2011_growth)
summary(mod3)
V_Ua <- vcovHC(mod3, type = "HC0")
V_diag_Ua <- sqrt(diag(V_Ua))
...
#Долгосрочная ориентация
mod4 <- lm(data = data1, GDP_growth_2011 ~ Long.term.orientation + Population_15_64_2011_growth + Inflation_2011+Capital_stock_2011_growth)
summary(mod4)
V_Lo <- vcovHC(mod4, type = "HC0")
V_diag_Lo <- sqrt(diag(V_Lo))
...
#Маскулинность
mod5 <- lm(data = data1, GDP_growth_2011 ~ Masculinity + Population_15_64_2011_growth + Inflation_2011+Capital_stock_2011_growth)
summary(mod5)
V_Ma <- vcovHC(mod5, type = "HC0")
V_diag_Ma <- sqrt(diag(V_Ma))

#Удовлетворённость жизнью
mod6 <- lm(data = data1, GDP_growth_2011 ~ Indulgence + Population_15_64_2011_growth + Inflation_2011+Capital_stock_2011_growth)
summary(mod6)
V_Ig <- vcovHC(mod6, type = "HC0")
V_diag_Ig <- sqrt(diag(V_Ig))
...
#Дистанция власти и индивидуализм
mod7 <- lm(data = data1, GDP_growth_2011 ~ Power.distance +Individualism + Population_15_64_2011_growth + Inflation_2011+Capital_stock_2011_growth)
summary(mod7)
V_Ind_Pd <- vcovHC(mod7, type = "HC0")
V_diag_Ind_Pd <- sqrt(diag(V_Ind_Pd))

#Долгосрочная ориентация и удовлетворённость жизнью
mod8 <- lm(data = data1, GDP_growth_2011 ~ Long.term.orientation+Indulgence + Population_15_64_2011_growth + Inflation_2011+Capital_stock_2011_growth)
summary(mod8)
V_LR_Ind <- vcovHC(mod8, type = "HC0")
V_diag_LR_Ind <- sqrt(diag(V_LR_Ind))

stargazer(mod1,mod2,mod3,mod4,mod5,mod6,mod7,mod8, type="html",out = "Hofstede_components_2011.htm",se=list(V_diag_Pd, V_diag_Ind,V_diag_Ua,V_diag_Lo,V_diag_Ma,V_diag_Ig,V_diag_Ind_Pd,V_diag_LR_Ind))
